 # flickr-uploader
 ----------------
 by oPromessa, 2017, V2.7.1 [![Master Build Status](https://travis-ci.org/oPromessa/flickr-uploader.svg?branch=master)](https://travis-ci.org/oPromessa/flickr-uploader)
